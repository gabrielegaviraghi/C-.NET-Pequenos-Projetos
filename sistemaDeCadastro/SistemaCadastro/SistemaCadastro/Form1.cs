...
namespace SistemaCadastro
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            // adicionar opções no campo Estado Civil
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            {
                pessoas[index] = p; // pegar indice já existente para alterar 
            }
        ...
        private void btnLimpar_Click(object sender, EventArgs e)
        {
            ...
            radioM.Checked = true; // vai ficar marcado ao limpar os outros campos
